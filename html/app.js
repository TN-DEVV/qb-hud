...
const app = Vue.createApp({
  data: function() {
      ...
      isDynamicAddictmethChecked: this.initIsDynamicAddictmethChecked(),
      isDynamicAddictcokeChecked: this.initIsDynamicAddictcokeChecked(),
  ...
  watch: {
    ...
    isDynamicAddictmethChecked: function() {
			localStorage.setItem("isDynamicAddictmethChecked", this.isDynamicAddictmethChecked);
		},
    isDynamicAddictcokeChecked: function() {
			localStorage.setItem("isDynamicAddictcokeChecked", this.isDynamicAddictcokeChecked);
		},
  ...
  methods: {
    ...
    initIsDynamicAddictmethChecked: function() {
			const stored = localStorage.getItem("isDynamicAddictmethChecked");
			if (stored === null) {
				return false;
			} else {
				return stored == 'true';
    ...
    initIsDynamicAddictcokeChecked: function() {
			const stored = localStorage.getItem("isDynamicAddictcokeChecked");
			if (stored === null) {
				return false;
			} else {
				return stored == 'true';
    ...
    dynamicAddictmeth: function(event) {
      targetId = event.currentTarget.id;
      dynamicAddictmeth()
    },
    dynamicAddictcoke: function(event) {
      targetId = event.currentTarget.id;
      dynamicAddictcoke()
    },
...
function dynamicAddictmeth() {
  $.post('https://qb-hud/dynamicAddictmeth');
}
function dynamicAddictcoke() {
  $.post('https://qb-hud/dynamicAddictcoke');
}
...
const playerHud = {
  ...
  methods: {
    hudTick(data) {
      ...
      this.addictmeth = data.addictmeth;
      this.addictcoke = data.addictcoke;
      ...
      this.dynamicAddictmeth = data.dynamicAddictmeth;
      this.dynamicAddictcoke = data.dynamicAddictcoke;
      ...
      if (data.dynamicAddictmeth == true) {
        if (data.addictmeth >= 100) {
          this.showAddictmeth = false; }
          else{
            this.showAddictmeth = true;
          }
      } else if (data.dynamicAddictmeth == false){
        this.showAddictmeth = true;
      } 
      if (data.addictmeth >= 100) {
        this.addictmethColor = "#0da1d6";
      } else if(data.addictmeth <= 30){
        this.addictmethColor = "#ff0000";
      } else{
        this.addictmethColor = "#0da1d6";
      }

      if (data.dynamicAddictcoke == true) {
        if (data.addictcoke >= 100) {
          this.showAddictcoke = false; }
          else{
            this.showAddictcoke = true;
          }
      } else if (data.dynamicAddictcoke == false){
        this.showAddictcoke = true;
      } 
      if (data.addictcoke >= 100) {
        this.addictcokeColor = "#7b2ab5";
      } else if(data.addictcoke <= 30){
        this.addictcokeColor = "#ff0000";
      } else{
        this.addictcokeColor = "#7b2ab5";
      }
